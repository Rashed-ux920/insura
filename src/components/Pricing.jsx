...
const Pricing = () => {
  return (
    <section className="bg-gray-900/30 py-24 lg:py-32" id="pricing">
      <div className="max-w-5xl mx-auto px-4">
        <div className="bg-gray-900 rounded-2xl shadow-lg p-8 md:p-10 border border-spotify-green">
          ...
          <div className="flex justify-center items-stretch flex-wrap gap-6">
            ...
            {/* Card */}
            <div className="w-full sm:w-[340px] rounded-xl border border-spotify-green bg-deep-black p-8 shadow-lg">
